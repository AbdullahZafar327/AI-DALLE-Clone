    ...
    <section className='w-max-7xl mx-auto'>
        <div>
         ...
         <p className='text-[#666375] mt-2 text-[14px] max-w-[500px]'>
            Create imaginative collection of Visually Stunning images and share with By Dalle-E Community
         </p>
        </div>
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
            ...
            <div className='relative bg-gray-50 border-gray-300 text-gray-900 focus:ring-blue-500 text-sm rounded-lg border focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
                 {form?.photo? (
